  ...
  VentureCapital: [
    {
      ...
      text: 'IronWallet is an all-encompassing financial solution for the tech-savvy generation. It brings together premium banking and wealth management services, covering everything from savings accounts to commercial paper S&P, private equity in small and medium enterprises, and real estate.',
      url: '',
    },
    {
      img: logoSnowball,
      ...
      title: 'Snowball',
      subtitle: 'VENTURE CAPITAL US MARKET ENTRY',
      text: "Snowball is the largest equity crowdfunding platform in Latin America and is certified by the National Banking and Securities Commission (CNBV, in Spanish) to operate as an Equity Crowdfunding Institution. Snowball has placed more than +133,000,000.00 million pesos (USD 6.6 million) in highly profitable companies, which have delivered more than +16.2 million pesos (USD 800K) in returns to thousands of investors. This, in the company's first commercial operation year alone. Snowball is the only FinTech with a secondary market that is 100% digital, automated, peer-to-peer.",
    ...
    },
    {
      ...
      title: 'Soop',
      subtitle: 'VENTURE CAPITAL US MARKET ENTRY',
      text: "Soop is a cloud-based FoodTech B2B SaaS for Food Hygiene Management. Soop's platform is built from the ground up for a seamless and paperless experience, allowing users to perform their daily food hygiene management tasks in no time using any already available device. At the core of Soop’s value proposition is the ability to reduce food-borne illnesses and food & paper waste by digitalizing current paper-based Food Hygiene Management practices. Ironman Capital Partners has now joined Soop as an accelerator program to connect, fundraise, and establish strategic alliances in the company. Their primary business in the US Market.",
    ...
    },
    {
      ...
      title: 'Arthur & Sons',
      subtitle: 'VENTURE CAPITAL US MARKET ENTRY',
      text: "Arthur & Sons offers a new way of smart-shopping eyewear. We are a company born from family tradition, always looking for its own style, innovation in eyewear lens design, and providing its customers with a unique on-site full-service shopping experience. The three Berdichevsky brothers come from generations of optometrists and have more than 20 years of experience, specializing in modern, affordable, high-quality eyeglasses, sunglasses, and prescription glasses. Ironman Capital Partners has joined Arthur & Sons as a South Florida soft-landing and accelerator platform to connect and establish strategic alliances to penetrate the world's largest market: The United States.",
    ...
    },
    {
      ...
      title: 'La Reina',
      subtitle: 'VENTURE CAPITAL US MARKET ENTRY',
      text: 'La Reina® Raicilla (raicilla de la sierra) is an Agave Spirit made exclusively with agave maximiliana. This kind of agave is a unique endemic species that prefers the hilly shady areas for the sierra to grow.',
    ...
    },
    {
      ...
      title: 'Woof',
      subtitle: 'VENTURE CAPITAL US MARKET ENTRY',
      text: 'Only pet shop chain with free same-day delivery and spectacular service in 250+ cities. It has the largest network of affiliated pet shops in Brazil with +2500 pet shops. Its mission is to provide more quality of life for your pet with convenience.',
